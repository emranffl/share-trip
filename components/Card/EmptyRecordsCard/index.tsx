...
const EmptyRecordsCard = ({
  ...
  return (
    ...
    >
      ...
      {image !== null && (
        <>
          <svg
            ...
            width={mergedImageProps?.width}
            height={mergedImageProps?.height}
            viewBox="0 0 647.63626 632.17383"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            className={cn("grayscale", mergedImageProps?.className)}
          >
            <path
      ...
      <p className={cn("text-sm text-slate-500", mergedTextProps.className)}>
